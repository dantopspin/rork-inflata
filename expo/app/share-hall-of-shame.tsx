      ...
      >
        ...
        {hasShameToShow ? (
          <>
            ...
            <Pressable
              onPress={() =>
                captureAndShare(
                  cardRef,
                  `My personal grocery inflation: ${fmtPct(inflation)}. The worst offender? ${top[0].name}. Tracked with Inflata.`,
                )
              }
          ...
          <View style={{ marginTop: 24 }}>
            <Text style={styles.title}>Nothing to call out — yet.</Text>
            <Text style={styles.body}>
              None of your tracked items have gone up in price. Keep scanning — this card fills in
              the moment something spikes.
            </Text>
          </View>
        )}
      </ScrollView>
